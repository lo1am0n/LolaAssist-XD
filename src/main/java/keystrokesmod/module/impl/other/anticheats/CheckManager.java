...
import keystrokesmod.module.impl.other.anticheats.checks.v1.combat.autoblock.AutoBlockA;
import keystrokesmod.module.impl.other.anticheats.checks.v1.movement.blink.BlinkA;
import keystrokesmod.module.impl.other.anticheats.checks.v1.movement.flight.FlightA;
import keystrokesmod.module.impl.other.anticheats.checks.v1.movement.flight.FlightB;
import keystrokesmod.module.impl.other.anticheats.checks.v1.movement.flight.MotionA;
import keystrokesmod.module.impl.other.anticheats.checks.v1.movement.ground.GroundSpoofA;
import keystrokesmod.module.impl.other.anticheats.checks.v1.movement.ground.GroundSpoofB;
import keystrokesmod.module.impl.other.anticheats.checks.v1.combat.hitbox.HitBoxA;
import keystrokesmod.module.impl.other.anticheats.checks.v1.player.nofall.NoFallA;
import keystrokesmod.module.impl.other.anticheats.checks.v1.movement.noslow.NoSlowA;
import keystrokesmod.module.impl.other.anticheats.checks.v1.combat.range.ReachA;
import keystrokesmod.module.impl.other.anticheats.checks.v1.movement.speed.SpeedA;
import keystrokesmod.module.impl.other.anticheats.checks.v1.movement.speed.SpeedB;
import keystrokesmod.module.impl.other.anticheats.checks.v1.movement.strafe.StrafeA;
import keystrokesmod.module.impl.other.anticheats.utils.world.EntityUtils;
import keystrokesmod.module.impl.other.anticheats.checks.v1.combat.aimassist.*;
import keystrokesmod.module.impl.other.anticheats.checks.v1.player.scaffold.*;
...
//        normal.put(SpeedC.class, new SpeedC(player));
        ...
        normal.put(AimAssistA.class, new AimAssistA(player));
        normal.put(AimAssistB.class, new AimAssistB(player));
        normal.put(AimAssistC.class, new AimAssistC(player));
